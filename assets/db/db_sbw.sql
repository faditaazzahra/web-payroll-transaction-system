...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Bulan Mei 2025 pada 16.45
...
--
-- Struktur dari tabel `transaksi_karyawan`
--
...
--
-- Struktur dari tabel `upah_harian`
--
...
--
-- Indeks untuk tabel `transaksi_karyawan`
--
...
--
-- Indeks untuk tabel `upah_harian`
--
...
--
-- AUTO_INCREMENT untuk tabel `transaksi_karyawan`
--
ALTER TABLE `transaksi_karyawan`
  MODIFY `id_transaksi_karyawan` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `upah_harian`
--
ALTER TABLE `upah_harian`
...
--
-- Ketidakleluasaan untuk tabel `pendapatan_harian`
--
ALTER TABLE `pendapatan_harian`
...
--
-- Ketidakleluasaan untuk tabel `transaksi_karyawan`
--
ALTER TABLE `transaksi_karyawan`
...
--
-- Ketidakleluasaan untuk tabel `upah_harian`
--
ALTER TABLE `upah_harian`
